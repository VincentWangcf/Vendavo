...
public class ReportsUtil {
	...
	public static Date extractDateFromFileName(String fileName) throws ParseException {
		String timeStr = fileName.substring(fileName.lastIndexOf(ReportConstant.HYPHEN_SIGN) + 1, fileName.indexOf("."));
		DateFormat df = new SimpleDateFormat("yyyyMMddHHmmssSSS");
		Date date = null;
		try {
			...
			date = new Date();	//20181218 (whwong) set default value when error, to avoid error because of failed to capture the datetime
			//throw e;
		}
		return date;
	}
