...
public class CatalogMaintenanceOffLineReport extends OffLineReport implements OffLineRemote {
	...
	private static final Logger LOG = Logger.getLogger(CatalogMaintenanceOffLineReport.class.getName());
...
//			reportFilePath = "C:/Lenon/temp";
			...
			for (int i = 0; i <= count; i++) {
				...
				List newList = TransferHelper.transferPricerToPIMainVo(resultList,criteria.getBizUnit());
