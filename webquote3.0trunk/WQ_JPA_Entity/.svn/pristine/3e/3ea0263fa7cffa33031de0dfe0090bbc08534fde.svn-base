...
//				vo.setBuyCurrency(qp.getCostM().getCurrency().name());
				vo.setBuyCurrency(qp.getCurrency().name());
	...
	public static String convertNormalSellPrice(List<QuantityBreakPrice> pricesList) {
		...
		for (int i = 0; i < size; i++) {
			if (pricesList.get(i).getQuantityBreakPrice() != null) {
				sb.append("<div>").append(DF5.format(pricesList.get(i).getQuantityBreakPrice())).append("</div>");
			}else {
				sb.append("<div>").append(STR_SPACE).append("</div>");
			}
		}
		sb.append("</div>");
		return sb.toString();
	...
	public static String convertSalesCost(List<QuantityBreakPrice> pricesList) {
		...
		for (int i = 0; i < size; i++) {
			if (pricesList.get(i).getSalesCost() != null) {
				sb.append("<div>").append(DF5.format(pricesList.get(i).getSalesCost())).append("</div>");
			}else {
				sb.append("<div>").append(STR_SPACE).append("</div>");
			}
		}
	...
	public static String convertSuggestedResale(List<QuantityBreakPrice> pricesList) {
		...
		for (int i = 0; i < size; i++) {
			if (pricesList.get(i).getSuggestedResale() != null) {
				sb.append("<div>").append(DF5.format(pricesList.get(i).getSuggestedResale())).append("</div>");
			}else {
				//break;
				sb.append("<div>").append(STR_SPACE).append("</div>");
			}
	...
	public static String convertQrderQtyForExcel(List<QuantityBreakPrice> pricesList, boolean... useEscapeLine) {
		...
		StringBuffer sb = new StringBuffer("");
		int size = (qbPSize >= 5) ? 5 : qbPSize;
		String excelLineBreak = (useEscapeLine.length>0 && useEscapeLine[0])? 
	...
	public static String convertNormalSellPriceForExcel(List<QuantityBreakPrice> pricesList, boolean... useEscapeLine) {
		...
		for (int i = 0; i < size; i++) {
			if (pricesList.get(i).getQuantityBreakPrice() != null) {
				sb.append(DF5.format(pricesList.get(i).getQuantityBreakPrice())).append(excelLineBreak);
			}else {
				break;
			}
		}
	...
	public static String convertSalesCostForExcel(List<QuantityBreakPrice> pricesList, boolean... useEscapeLine) {
		...
		for (int i = 0; i < size; i++) {
			if (pricesList.get(i).getSalesCost() != null) {
				sb.append(DF5.format(pricesList.get(i).getSalesCost())).append(excelLineBreak);
			}else {
				break;
			}
		}
	...
	public static String convertSuggestedResaleForExcel(List<QuantityBreakPrice> pricesList, boolean... useEscapeLine) {
		...
		for (int i = 0; i < size; i++) {
			if (pricesList.get(i).getSuggestedResale() != null) {
				sb.append(DF5.format(pricesList.get(i).getSuggestedResale())).append(excelLineBreak);
			}else {
				break;
			}
		}
...
//			Money costM = pi.getCostM();
//			Currency currency = costM.getCurrency();
//			pimv.setBuyCurrency(pi.getCostM().getCurrency().name());
			pimv.setBuyCurrency(pi.getCurrency().name());
