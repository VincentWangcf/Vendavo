...
//	private long manufacturerID;
	...
	public ReferenceMarginSetting() {
		
	}
	
	public static ReferenceMarginSetting createDefaultOne() {
		ReferenceMarginSetting refMargin = new ReferenceMarginSetting();
		refMargin.setFactor(100);
		refMargin.setFloor(0);
		refMargin.setCap(9999);
		return refMargin;
	}
