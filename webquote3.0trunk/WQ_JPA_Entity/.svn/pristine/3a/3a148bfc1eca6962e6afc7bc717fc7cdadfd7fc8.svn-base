...
*/
	...
	void fillInPricer(RfqItemVO rfqItem) {
		...
		try {
			...
			logger.warning(MessageFormat.format("fillInPricer ContractPricer ,"
					+ " id:[{0}] convert to RfqCurr:[{1}] Money throw exception. " + e.getMessage(), this.getId(), rfqItem.getRfqCurr()));
		}*/
