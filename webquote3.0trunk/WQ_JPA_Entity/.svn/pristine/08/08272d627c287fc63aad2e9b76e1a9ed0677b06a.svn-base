...
public class QuantityBreakPrice implements Serializable {
	...
	@AttributeOverrides(value = {
			@javax.persistence.AttributeOverride(name = "amount", column = @Column(name = "SALES_COST")),
	        @javax.persistence.AttributeOverride(name = "currency", column = @Column(name = "CURRENCY"))})
	private Money salesCostM;*/
	...
	/*public Money getSalesCostM() {
		return salesCostM;
	}

	public void setSalesCostM(Money salesCostM) {
		this.salesCostM = salesCostM;
	}*/
