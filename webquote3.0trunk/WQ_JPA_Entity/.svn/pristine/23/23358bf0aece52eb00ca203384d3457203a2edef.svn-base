...
import com.avnet.emasia.webquote.strategy.JapanMoneyConvertStrategy;
...
public class MoneyTest {
	...
	public void test1() {
		...
		Money convertTo = money.convertToRfq(Currency.RMB, bizUnit, customer, new Date());
	...
	public void test3() {
		...
		Money convertTo = money.convertToRfq(Currency.RMB, bizUnit, null, new Date());
		Money money2 = Money.of("5.18980", "RMB");
		assertEquals(convertTo, money2);
	...
	public void test6() {
		...
		Money convertTo = money.convertToRfq(Currency.EUR, bizUnit, customer, new Date());
	...
	public void test7() {
		...
		Money money1 = Money.of("1.00001", "RMB").convertToRfq(Currency.USD, bizUnit, null, new Date(),5);
		Money money2 = Money.of("1", "RMB").convertToRfq(Currency.USD, bizUnit, null, new Date(),5);
		assertEquals(money1, money2);
		
		money1 = Money.of("1.00001", "RMB").convertToRfq(Currency.USD, bizUnit, null, new Date());
		money2 = Money.of("1", "RMB").convertToRfq(Currency.USD, bizUnit, null, new Date());
		assertEquals(money1, money2);
		
		money1 = Money.of("1.00001", "RMB").convertToRfq(Currency.USD, bizUnit, null, new Date(),6);
		money2 = Money.of("1", "RMB").convertToRfq(Currency.USD, bizUnit, null, new Date(),6);
...
//		rates.add(r8);
	...
	@Override
	public void clear(ActionIndicator actionIndicator) {
