...
public class Constants {
	...
	public static final int ROUNDING_MODE = BigDecimal.ROUND_HALF_UP; // BigDecimal.ROUND_HALF_UP = 4 
	
	public static final int SCALE_FOR_COMPARE = 10;
	public static final int SCALE_FOR_QUOTEDPRICE = 10;
