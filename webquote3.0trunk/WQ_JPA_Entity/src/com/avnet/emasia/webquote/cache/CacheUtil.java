...
public class CacheUtil implements ICacheUtil {
	...
	public void init(){
		...
		//.setStoreByValue(false) let outbound get real data , not duplicate.
...
//    	designLocation.add("-select-"); 
	...
	*/
	...
	public List<ExchangeRate> getExchangeRates() 
	{
		...
		//LOG.info("cost of getExchangeRates()::" + (st -end));
		return results;
	}
	...
	public void clear(ActionIndicator actionIndicator) {
		...
		LOG.info("Clear this Entity mapCache :::::::::" + System.identityHashCode(this.mapCache));
