 ...
 */
@FacesRenderer(componentFamily="org.primefaces.component", rendererType="com.avnet.emasia.FilterEnhancedDataTable")
public class FilterEnhancedDataTableRenderer extends DataTableRenderer {
   ...
   protected void encodeFilter(FacesContext context, DataTable table, UIColumn column) throws IOException {
      ...
      String filterValue = params.containsKey(filterId) && !table.isReset() ? params.get(filterId) : 
               (String)(table.getFilters().get(filterField)); // <-- and here, was ""
