...
@FacesConverter("webquote.commodity.Announcement")
public class AnnouncementConverter implements Converter {
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		...
		{
			if(anno.getDescription().length()>110)
			{
				sb.append(anno.getDescription().substring(0, 110)).append("...");
			}
			else
			{
