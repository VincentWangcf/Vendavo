...
//    		logger.info("initialize checkBoxSet is null");
    ...
    public void handleOutSideLink()
    {
        ...
        searchQtyBreakPricer(false, checkBoxSet);
    }
	...
	{
		//defaultAction();
		CheckBoxSet checkBoxSet = getCheckBoxSetForItem(false);
	    ...
	    checkBoxSet.setMfr(checkBoxSet.specifiedOneMfr(programMaterialSB.getMfrList(pis),selectedMaterial.getManufacturer().getName()));
	    checkBoxSet.setProductGroup(programMaterialSB.getProductGroupList(pis));
	    checkBoxSet.setProgramType(programMaterialSB.getProgramTypeList(pis));
	...
	public CheckBoxSet getCheckBoxSetForItem(boolean forReset)
	{
		LOGGER.fine("call |  defaultAction");
		mfrPart = null;
	    //resetCheckBox();
	    CheckBoxSet checkBoxSet = new CheckBoxSet();
		loadRestrictions(forReset);
		PISearchBean pis = checkBoxSet.getPiSearchBean(false);
		pis.setActive(Constants.YES);
		pis.setBizUnit(bizUnitStr);
	    ...
	    checkBoxSet.setMfr(programMaterialSB.getMfrList(pis));
	   //checkBoxSet.setProductGroup(productGroupList);
	    checkBoxSet.setProgramType(programMaterialSB.getProgramTypeList(pis));
	    checkBoxSet.setSuccess(true);
	    checkBoxSet.setActive(Constants.YES);
	...
	public void searchQtyBreakPricer(boolean isDefaultSearch,CheckBoxSet checkBoxSet) {
