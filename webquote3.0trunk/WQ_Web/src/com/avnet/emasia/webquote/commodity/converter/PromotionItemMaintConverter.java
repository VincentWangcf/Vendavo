...
@FacesConverter("webquote.commodity.PromotionItemMaint")
public class PromotionItemMaintConverter implements Converter {
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		...
		if(pi.getDescription()!=null)
		{
			...
			{
				returnSb.append(sb.toString().substring(0, 35)).append("...");
			}
			else
			{
