...
public class MaterialRegionalDAOImpl implements MaterialRegionalDAO {
	...
	public void batchStartUpdate() throws IllegalStateException, SecurityException, SystemException {
		...
		try {
	    	...
	    	Query q1 = em.createQuery("UPDATE MaterialRegional v set v.batchStatus = v.batchStatus + 10 where v.batchStatus < 10 AND  (SELECT COUNT(o) FROM v.material.sapMaterials o)> 0");
