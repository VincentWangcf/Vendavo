 ...
 */
@Stateless
public class DrmsAgpReaScheduleJob extends StandardJob
{
	private static Logger logger = Logger.getLogger(DrmsAgpReaScheduleJob.class.getName());
  ...
  //For schedule job
	...
	public void executeTask(Timer timer) {
		...
		try {
			...
			logger.log(Level.SEVERE, "Exception occured in DrmsAgpReaScheduleJob#executeTask for Timer: " + timer.getInfo() + ", Task: " + this.getType()
	...
	{
    		logger.info("The class DrmsAgpReaScheduleJob of  method loadingAction() call...");
