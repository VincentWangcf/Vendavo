...
public class PISearchBean implements Serializable {
	...
	public static final String SALES_COST_YES = "Yes";
	
	public static final String SALES_COST_NO = "No";
	...
	public Boolean getSalesCostFlag() {
		if(SALES_COST_YES.equals(getSalesCostPart())) {
			salesCostFlag = true;
		}else if(SALES_COST_NO.equals(getSalesCostPart())) {
			salesCostFlag = false;
		}else {
			salesCostFlag = null;
		}
