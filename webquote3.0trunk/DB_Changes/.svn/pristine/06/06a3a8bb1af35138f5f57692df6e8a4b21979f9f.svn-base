drop view QUOTE_ITEM_BMT_VIEW;

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "WEBQUOTE"."QUOTE_ITEM_BMT_VIEW" ("BIZ_UNIT", "FORM_NUMBER", "USER_ID", "SOLD_2_CUST_NAME", "SOLD_2_CUST_NO", "TEAM_ID"
  , "YOUR_REFERENCE", "AQCC", "BOM_NUMBER", "COST_INDICATOR", "CUSTOMER_TYPE", "DESIGN_IN_CAT", "DESIGN_LOCATION", "DESIGN_REGION", "END_CUST_NO", "END_CUST_NAME"
  , "ENQ_SEGMENT", "FIRST_RFQ_CODE", "FIS_MTH", "FIS_QTR", "FIS_YEAR", "ID", "INT_COMMENT", "INT_TRF_COMMENT", "LAST_BMT_I_DATE", "LAST_BMT_O_DATE", "LAST_IT_UP_TIME"
  , "LAST_QC_I_DATE", "LAST_QC_O_DATE", "LAST_RIT_UP_TIME", "LAST_SQ_I_DATE", "LAST_SQ_O_DATE", "LAST_UP_BMT_EID", "LAST_UP_PM_EID", "LAST_UP_QC_EID"
  , "PRODUCT_GROUP1_ID", "PRODUCT_GROUP2_ID", "PROD_GRP3", "PROD_GRP4", "QUOTE_NUMBER", "QUOTE_TYPE", "QUOTED_PART_NUM", "QUOTED_QTY", "REQ_MFR_ID", "REQ_PART_NUM"
  , "REQ_QTY", "REVERT_VER", "SENT_O_TIME", "STAGE", "STATUS", "SUBMISSION_DATE", "DELTA_DATE", "PROGRAM_TYPE", "MATERIAL_TYPE_ID", "QUOTATION_EFFECTIVE_DATE"
  , "PRICE_VALIDITY", "PO_EXPIRY_DATE", "RESALE_MARGIN", "QUOTE_EXPIRY_DATE", "SHIPMENT_VALIDITY", "DR_NEDA_ID", "PROJECT_NAME", "APPLICATION"
  , "SUPPLIER_DR_NUMBER", "VENDOR_DEBIT_NUMBER", "VENDOR_QUOTE_NUMBER", "VENDOR_QUOTE_QTY", "PP_SCHEDULE", "MP_SCHEDULE", "LOA_FLAG", "EAU", "COMPETITOR_INFORMATION"
  , "REMARKS", "REASON_FOR_REFRESH", "CREATED_BY", "LAST_UPDATED_BY", "PRODUCT_GROUP2", "MFR_NAME", "SAP_PART_NUMBER", "SALES_NAME", "SALES_EID"
  , "SPR_FLAG", "QUOTED_BY", "SOLD_2_CUST_NAME_CHINESE", "PMOQ", "MPQ", "MOQ", "MOV", "LEAD_TIME", "MULTI_USAGE_FLAG", "QTY_INDICATOR", "RESALE_INDICATOR", "RESALE_MAX", "RESALE_MIN"
  , "RESCHEDULE_WINDOW", "CANCELLATION_WINDOW", "TERMS_AND_CONDITIONS", "ALLOCATION_FLAG", "SHIP_2_CUST_NAME", "SHIP_2_CUST_NO", "AUTH_GP", "AUTH_GP_REASON_DESC", "ATTACHMENT_FLAG"
  , "BMT_FLAG_CODE", "DR_COMMENTS", "BMT_SUGGEST_COST", "DR_MFR_NO", "BMT_SUGGEST_RESALE", "DR_EFFECTIVE_DATE", "DR_EXPIRY_DATE", "DR_QUOTE_QTY", "DR_COST_ALT_CURRENCY"
  , "DR_RESALE_ALT_CURRENCY", "DR_ALT_CURRENCY", "DR_EXCHANGE_RATE", "DR_MFR_QUOTE_NO", "DRMS_NUMBER"
  ,"COST", "QUOTED_PRICE", "TARGET_RESALE", "FINAL_QUOTATION_PRICE", "REF_EX_RATE", "REF_EX_CURR"
  ) AS 
  SELECT 
...
CASE 
WHEN NVL(QUOTE_ITEM.LAST_UPDATED_ON,QUOTE.CREATED_ON) >= D.LAST_UPDATED_TIME THEN TO_CHAR(NVL(QUOTE_ITEM.LAST_UPDATED_ON,QUOTE.CREATED_ON), 'YYYYMMDDHH24MISS') 
ELSE TO_CHAR(D.LAST_UPDATED_TIME, 'YYYYMMDDHH24MISS')
END AS DELTA_DATE
...
,UPPER(D.BMT_FLAG_CODE) AS BMT_FLAG_CODE
,UPPER(D.DR_COMMENTS) AS DR_COMMENTS
,D.DR_COST AS BMT_SUGGEST_COST
,UPPER(D.DR_MFR_NO) AS DR_MFR_NO
,D.DR_RESALE AS BMT_SUGGEST_RESALE
,TO_CHAR(D.DR_EFFECTIVE_DATE, 'YYYYMMDDHH24MISS') AS DR_EFFECTIVE_DATE
,TO_CHAR(D.DR_EXPIRY_DATE, 'YYYYMMDDHH24MISS') AS DR_EXPIRY_DATE
,D.DR_QUOTE_QTY
,D.DR_COST_ALT_CURRENCY
,D.DR_RESALE_ALT_CURRENCY
,UPPER(D.DR_ALT_CURRENCY) AS DR_ALT_CURRENCY
,D.DR_EXCHANGE_RATE
,UPPER(D.DR_MFR_QUOTE_NO) AS DR_MFR_QUOTE_NO
,QUOTE_ITEM.DRMS_NUMBER
---------------------------------------------------
...
--,QUOTE_ITEM.FINAL_QUOTATION_PRICE AS FINAL_QUOTATION_PRICE
...
JOIN QUOTE_ITEM_DESIGN D ON QUOTE_ITEM.ID = D.QUOTE_ITEM_ID;
