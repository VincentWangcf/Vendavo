...
ALTER TABLE PRICER modify MATERIAL_CATEGORY NULL;
ALTER TABLE PRICER MODIFY  AVAILABLE_TO_SELL_MORE_FLAG  NULL;
ALTER TABLE PRICER ADD (PRE_VALID_TO_DATE DATE );
...
--commneted by DamonChen ,as the column is already NOT NULL.
