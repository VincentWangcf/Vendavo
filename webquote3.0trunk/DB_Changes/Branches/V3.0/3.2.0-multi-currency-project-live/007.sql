...
Insert into APP_MESSAGES (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) VALUES ((select max(id)+1 from APP_MESSAGES),'en','wq.error.dLink003','Final Quotation Price must be filled in.');
...
Insert into APP_MESSAGES (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) VALUES ((select max(id)+1 from APP_MESSAGES),'en','wq.message.notAllowChildDLink_FinalQuote','Update final quotation price is not allowed for child $Link quotes.');
...
UPDATE APP_MESSAGES SET MESSAGE = 'Final quotation price has been updated in WebQuote, but failed to update in SAP.' WHERE MESSAGE_CODE = 'wq.error.90032' AND LOCALE_ID='en';
--UPDATE APP_MESSAGES SET MESSAGE = '??????? WebQuote ????????SAP???' WHERE MESSAGE_CODE = 'wq.error.90032' AND LOCALE_ID='zh'
...
--*Sales Cost (BUY CUR) -salesCost
INSERT INTO EXCEL_REPORT_COLUMN (ID,HEADER_NAME,BEAN_PROPERTY,CELL_DATA_TYPE) values ((select max(id)+1 from EXCEL_REPORT_COLUMN),'Sales Cost (BUY CUR)','salesCost','2');
--*Suggested Resale (BUY CUR) -suggestedResale
INSERT INTO EXCEL_REPORT_COLUMN (ID,HEADER_NAME,BEAN_PROPERTY,CELL_DATA_TYPE) values ((select max(id)+1 from EXCEL_REPORT_COLUMN),'Suggested Resale (BUY CUR)','suggestedResale','2');
...
--*SalesCost
UPDATE EXCEL_REPORT_COLUMN SET HEADER_NAME='Sales Cost (RFQ CUR)', BEAN_PROPERTY='salesCostRFQCur' 
WHERE "ID" IN (SELECT COLUMN_ID FROM EXCEL_REPORT_SEQ WHERE REPORT_ID=(SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_QC') AND SEQ_NO='168')
    AND HEADER_NAME='Sales Cost';

	
--*suggestedResale
UPDATE EXCEL_REPORT_COLUMN SET HEADER_NAME='Suggested Resale (RFQ CUR)', BEAN_PROPERTY='suggestedResaleRFQCur' 
WHERE "ID" IN (SELECT COLUMN_ID FROM EXCEL_REPORT_SEQ WHERE REPORT_ID=(SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_QC') AND SEQ_NO='176')
    AND HEADER_NAME='Suggested Resale';


/*
UPDATE EXCEL_REPORT_COLUMN SET HEADER_NAME='Final Quoted Price'
WHERE "ID" IN (SELECT COLUMN_ID FROM EXCEL_REPORT_SEQ WHERE REPORT_ID IN (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME like 'MYQUOTE_%'))
    AND HEADER_NAME='Final Quotation Price' AND BEAN_PROPERTY='finalQuotationPrice';
*/
/*
...
-------------------------------------------------------------------------MYQUOTE_QC-----------------------------------------------------------------------------
--*Sales Cost Type (change seq no)
UPDATE EXCEL_REPORT_SEQ SET SEQ_NO='154'
WHERE REPORT_ID=(SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_QC') 
	AND COLUMN_ID IN (SELECT ID FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Sales Cost Type' AND BEAN_PROPERTY='salesCostTypeName')
	AND SEQ_NO='160';
...
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_QC'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='BUY CUR' AND BEAN_PROPERTY='buyCurr'), '156');


--**Cost (change seq no)
UPDATE EXCEL_REPORT_SEQ SET SEQ_NO='158'
WHERE REPORT_ID=(SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_QC') 
...
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_QC'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Sales Cost (BUY CUR)' AND BEAN_PROPERTY='salesCost'), '160');

--add suggestedResale
--*Suggested Resale (BUY CUR)
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_QC'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Suggested Resale (BUY CUR)' AND BEAN_PROPERTY='suggestedResale'), '161');
...
----------------------------------------------------------MYQUOTE_PM------------------------------------------------------
--*Sales Cost Type	salesCostTypeName (change seq no)
UPDATE EXCEL_REPORT_SEQ SET SEQ_NO='148'
...
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_PM'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='BUY CUR' AND BEAN_PROPERTY='buyCurr'), '150');


--**Cost (change seq no)
UPDATE EXCEL_REPORT_SEQ SET SEQ_NO='151'
WHERE REPORT_ID=(SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_PM') 
	AND COLUMN_ID IN (SELECT ID FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Cost' AND BEAN_PROPERTY='cost')
	AND SEQ_NO='200';
...
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_PM'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Sales Cost (BUY CUR)' AND BEAN_PROPERTY='salesCost'), '153');

--add suggestedResale
--*Suggested Resale
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_PM'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Suggested Resale (BUY CUR)' AND BEAN_PROPERTY='suggestedResale'), '154');
...
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_MM'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Sales Cost (BUY CUR)' AND BEAN_PROPERTY='salesCost'), '134');
...
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_MM'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Suggested Resale (BUY CUR)' AND BEAN_PROPERTY='suggestedResale'), '135');


--*Avnet Quoted Price (BUY CUR)
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_MM'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Avnet Quoted Price (BUY CUR)' AND BEAN_PROPERTY='avnetQuotePrice'), '136');


--**RFQ CUR
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_MM'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='RFQ CUR' AND BEAN_PROPERTY='currTo'), '138');

--*Sales Cost	salesCost (change seq no)
UPDATE EXCEL_REPORT_SEQ SET SEQ_NO='140'
WHERE REPORT_ID=(SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_MM') 
	AND COLUMN_ID IN (SELECT ID FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Sales Cost (RFQ CUR)' AND BEAN_PROPERTY='salesCostRFQCur')
	AND SEQ_NO='136';
...
INSERT INTO EXCEL_REPORT_SEQ (ID, REPORT_ID, COLUMN_ID, SEQ_NO) 
VALUES ((select max(id)+1 from EXCEL_REPORT_SEQ), (SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_BMT'), 
    (SELECT MAX(ID) FROM EXCEL_REPORT_COLUMN WHERE HEADER_NAME='Avnet Quoted Price (BUY CUR)' AND BEAN_PROPERTY='avnetQuotePrice'), '165');
...
--Avnet Quoted Price (RFQ CUR)
--SELECT ers.* FROM EXCEL_REPORT_SEQ ers
UPDATE EXCEL_REPORT_SEQ SET COLUMN_ID = (SELECT ID FROM EXCEL_REPORT_COLUMN WHERE BEAN_PROPERTY='quotedPriceRFQCur')
WHERE REPORT_ID=(SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_BMT') 
    AND COLUMN_ID IN (SELECT ID FROM EXCEL_REPORT_COLUMN WHERE BEAN_PROPERTY='avnetQuotePrice')
    AND SEQ_NO=192;

--Target Resale (RFQ CUR)
--SELECT ers.* FROM EXCEL_REPORT_SEQ ers
UPDATE EXCEL_REPORT_SEQ SET COLUMN_ID = (SELECT ID FROM EXCEL_REPORT_COLUMN WHERE BEAN_PROPERTY='targetResale' AND HEADER_NAME='Target Resale (RFQ CUR)')
WHERE REPORT_ID=(SELECT ID FROM EXCEL_REPORT WHERE REPORT_NAME='MYQUOTE_BMT') 
    AND COLUMN_ID IN (SELECT ID FROM EXCEL_REPORT_COLUMN WHERE BEAN_PROPERTY='targetResale')
    AND SEQ_NO=200;
...
------------------------------------------------
--System Admin used new function: Maintain Admin Profile
INSERT INTO APP_FUNCTION(ID, NAME)
VALUES ((select max(id)+1 from APP_FUNCTION), 'Maintain Admin Profile');

INSERT INTO APP_RESOURCE (RESOURCE_TYPE, ID, PATH, APP_FUNCTION_ID, PATH_ORDER, VERSION)
VALUES ('SCREEN', (select max(id)+1 from APP_RESOURCE), '/UserMgmt/UserAdminRegionManagement.jsf', (SELECT ID FROM APP_FUNCTION WHERE NAME='Maintain Admin Profile'), 1, 1);

INSERT INTO APP_FUNCTION_ROLE_MAPPING (FUNCTION_ID, ROLE_ID)
VALUES ((SELECT ID FROM APP_FUNCTION WHERE NAME='Maintain Admin Profile'), (SELECT ID FROM ROLE WHERE NAME='ROLE_SYS_ADMIN'));

--Add new label
--en	wq.label.maintainUserProfile	Maintain User Profile
Insert into APP_LABEL (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) values ((select max(id)+1 from APP_LABEL),'en','wq.label.maintainAdminProfile','Maintain Admin Profile');
--New Message
Insert into APP_MESSAGES (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) VALUES ((select max(id)+1 from APP_MESSAGES),'en','wq.message.empIdcannotEmpty','Employee Id cannot be empty');

commit;

-------------------------------------------------------
--System Admin used new function: Maintain MFR
INSERT INTO APP_FUNCTION(ID, NAME)
VALUES ((select max(id)+1 from APP_FUNCTION), 'Maintain MFR');

INSERT INTO APP_RESOURCE (RESOURCE_TYPE, ID, PATH, APP_FUNCTION_ID, PATH_ORDER, VERSION)
VALUES ('SCREEN', (select max(id)+1 from APP_RESOURCE), '/Admin/MfrMaintenance.jsf', (SELECT ID FROM APP_FUNCTION WHERE NAME='Maintain MFR'), 1, 1);

INSERT INTO APP_FUNCTION_ROLE_MAPPING (FUNCTION_ID, ROLE_ID)
VALUES ((SELECT ID FROM APP_FUNCTION WHERE NAME='Maintain MFR'), (SELECT ID FROM ROLE WHERE NAME='ROLE_SYS_ADMIN'));

--Add new label

Insert into APP_LABEL (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) values ((select max(id)+1 from APP_LABEL),'en','wq.label.pricer','Pricer');
Insert into APP_LABEL (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) values ((select max(id)+1 from APP_LABEL),'en','wq.label.maintainMFR','Maintain MFR');

Insert into APP_MESSAGES (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) VALUES ((select max(id)+1 from APP_MESSAGES),'en','wq.message.mfrModify','Manufacturer has been modified by other admin users. Please search again and redo the changes.');
Insert into APP_MESSAGES (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) VALUES ((select max(id)+1 from APP_MESSAGES),'en','wq.message.recordMissing','Current record is missing, please search again and redo the changes.');
Insert into APP_MESSAGES (ID,LOCALE_ID,MESSAGE_CODE,MESSAGE) VALUES ((select max(id)+1 from APP_MESSAGES),'en','wq.message.mfrExist','MFR already exist');
