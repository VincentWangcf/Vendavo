...
--COLUMN
DECLARE 
  TYPE vc_ray IS VARRAY(2) OF VARCHAR2(50);
  heads vc_ray := vc_ray('Package Type', 'Packaging Type');
  propertys vc_ray := vc_ray('packageType', 'packagingType');
...
DECLARE 
  ...
  heads vc_ray := vc_ray('Package Type', 'Packaging Type');
  propertys vc_ray := vc_ray('packageType', 'packagingType');
  postionPrevPropertys vc_ray := vc_ray('productGroup4', 'packageType');
  property VARCHAR2(50);
  postionPrevProperty VARCHAR2(50);
  repo_name VARCHAR2(50) := 'PART_MASTER';
  r_id NUMBER(18,0);
  c_id NUMBER(18,0);
  head VARCHAR2(50);
