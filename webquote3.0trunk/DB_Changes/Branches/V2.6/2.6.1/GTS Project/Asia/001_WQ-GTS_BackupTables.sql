...
DECLARE
  ...
  cCOMMENT CONSTANT VARCHAR2(100 BYTE) := 'SokBoon: Backup for GTS Project';  -- Comment to add on backup tables
  ...
  BEGIN
    ...
    arrBuf := vCharArrayType('CUSTOMER'
                            ,'CUSTOMER_ADDRESS'
                            ,'CUSTOMER_PARTNER'
                            ,'CUSTOMER_SALE'
                            );
    ...
    arrBufNew := vCharArrayType('CUSTOMER'
                               ,'CUSTOMER_ADDRESS'
                               ,'CUSTOMER_PARTNER'
                               ,'CUSTOMER_SALE'
                               );
