...
public class CatalogSearchResult implements Serializable {
	...
	private String targetResaleStr;
	...
	public String getSalesCostStr() {
		return QuoteUtil.ConvertBigDecimalToStr(this.getSalesCost());
	}
	
	/***for export excel , pls do not remove**/
	public String getSuggestedResaleStr() {
		return QuoteUtil.ConvertBigDecimalToStr(this.getSuggestedResale());
	}
