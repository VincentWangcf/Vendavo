...
public class ExcelFileRowDataSource implements RowDataSource {
	private int seq = 0;
	...
	public ExcelFileRowDataSource(InputStream stream, ResolveInfo info) {
	...
	private class CommonProcessSheetInterface implements ProcessSheetInterface {
		...
		ExcelFileRowDataSource topDataSource = ExcelFileRowDataSource.this;
	...
	public List<String> getHeadNames() {
		return headNameMapColIndex.keySet().stream().collect(Collectors.toList());
	}
